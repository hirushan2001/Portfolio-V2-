        ...
        <div className="p-6">
          ...
          <AnimatePresence initial={false}>
            <motion.p
              ...
              className={`text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-2 ${
          ...
          {/* Toggle Button - only if description is long */}
          {project.description.length > 200 && (
            <button
              onClick={() => setExpanded(!expanded)}
              className="text-blue-600 dark:text-blue-400 text-sm font-medium hover:underline focus:outline-none mb-4"
            >
          ...
          >
            <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 bg-[length:400%_400%] animate-gradient-x rounded-2xl p-8 text-white">
              ...
              <p className="text-white/90 max-w-2xl mx-auto mb-6">
                ...
                more projects in my GitHub repositories, including open-source
